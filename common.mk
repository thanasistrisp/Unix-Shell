# common.mk (adapted from https://github.com/chatziko)
#
...
valgrind-%: %
	valgrind --error-exitcode=1 --leak-check=full --show-leak-kinds=all --show-reachable=no ./$* $($*_ARGS)
...
# τρέχον directory.
#
.PHONY: clean valgrind coverage lcov